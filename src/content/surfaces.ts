...
export const SECTIONS: Record<SectionId, SectionSpec> = {
  ...
  'rb-deck':      {id:'rb-deck',      surface:'software', label:'Player Deck',      rect:{x:0,    y:0.268, w:0.48, h:0.308}, marker:{x:0.24, y:0.40}},
  'rb-mixer':     {id:'rb-mixer',     surface:'software', label:'Performance & Mix',rect:{x:0,    y:0.047, w:1,    h:0.682}, marker:{x:0.58, y:0.19}},
  ...
  'rb-sources':   {id:'rb-sources',   surface:'software', label:'Browser & Library',rect:{x:0,    y:0.729, w:1,    h:0.271}, marker:{x:0.49, y:0.86}},
